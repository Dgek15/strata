...
<html>
	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="" class="image avatar"><img src="<?php the_field('avatar');?>" alt="" />
					</a>
		...
		<!-- Main -->
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						<header class="major">
							<h2>Подробная иформация о себе</h2>
						</header>
						<p>	<?php the_field('fullInformations'); ?>	</p>
						<ul class="actions">
			...
			<footer id="footer">
				<div class="inner">
					<ul class="icons">
						...
						<li><a href="<?php the_field('post') ?>" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
					</ul>
					<ul class="copyright">
